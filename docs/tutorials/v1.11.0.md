# Release Tutorial v1.11.0

Generated: 2026-02-22T16:31:22.572798Z
...
![Current running app UI](./v1.11.0-app.png)
...
## Operator Steps
1. Confirm image published for `v1.11.0` in GHCR and `latest` updated.

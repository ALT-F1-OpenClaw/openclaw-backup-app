# Release Tutorial v1.10.0

Generated: 2026-02-22T16:29:29.890849Z
...
![Current running app UI](./v1.10.0-app.png)
...
## Operator Steps
1. Confirm image published for `v1.10.0` in GHCR and `latest` updated.

# Release Tutorial v2.0.0

Generated: 2026-02-24T19:38:19.447270Z
...
![Current running app UI](./v2.0.0-app.png)
...
## Operator Steps
1. Confirm image published for `v2.0.0` in GHCR and `latest` updated.

# Release Tutorial v1.9.0

Generated: 2026-02-22T16:12:40.558071Z
...
![Running app UI](./v1.9.0-app.png)

## Operator Steps
1. Confirm image published for `v1.9.0` in GHCR and `latest` updated.
